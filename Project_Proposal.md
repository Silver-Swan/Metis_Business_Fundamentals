# Project Title - Making a predictive model that can help doctors diagnose patients for Cardiovascular diseases. 
<br>
...
Tools: 
<br>
Google sheets will be the tool that will be implimented. As well as maybe SQL and SQLite. For visualization, Tableau will be utilized.<br>
<br>
MVP Goal:
<br>
